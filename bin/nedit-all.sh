...
LOOK_INSIDE="continuum deep dynamics exercises fmi hybrid lenses tutorial utils utp vdm-sl"
...
# A poor-mans refactoring facility: use Multiple Documents replace in nedit.
nedit $NEDIT_FILES
