...
[upred_defs, mo_defs]:
  "Clock offset startTime y =
    \<lparr> mieqs = true
    , mdeqs = true\<^sub>r
    , maeqs = (&y =\<^sub>u \<guillemotleft>offset\<guillemotright> + (0 \<triangleleft> &mtime <\<^sub>u \<guillemotleft>startTime\<guillemotright> \<triangleright> &mtime - \<guillemotleft>startTime\<guillemotright>))
    , mqeqs = true
    , mreqs = {}
    , mzcfs = {}
...
[upred_defs, mo_defs]: 
  "Step height offset startTime y =
    ...
    , mdeqs = true\<^sub>r
    , maeqs = true
    , mqeqs = (&mtime =\<^sub>u \<guillemotleft>startTime\<guillemotright> \<Rightarrow> &y =\<^sub>u \<guillemotleft>offset + height\<guillemotright>)
    , mreqs = {}
    , mzcfs = {}
