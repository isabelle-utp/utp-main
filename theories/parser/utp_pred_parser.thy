...
(*
  ...
  "_uexpr_list_nil"    == "CONST EvNilE"
  "_uexpr_list_append e f"     == "CONST EvConcatE e f"
  "_uexpr_list (_uexprs x xs)" == "CONST EvConsE x (_uexpr_list xs)"
  "_uexpr_list x" == "CONST EvConsE x (CONST EvNilE)"
  "_uexpr_fset (_uexprs x xs)" == "CONST EvFInsertE x (_uexpr_list xs)"
  "_uexpr_fset x" == "CONST EvFInsertE x CONST EvFEmptyE"
  "_uexpr_fset_empty" == "CONST EvFEmptyE"
  "_uexpr_fset_union xs ys" == "CONST EvFUnionE xs ys"
  "_uexpr_fset_inter xs ys" == "CONST EvFInterE xs ys"
  "_uexpr_fset_member x xs"  == "CONST ExprP (CONST FMemberE x xs)"
  "_uexpr_fset_nmember x xs" == "CONST ExprP (CONST FNMemberE x xs)"
