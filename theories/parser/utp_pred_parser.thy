...
translations
  ...
  "_uexpr_list_nil"    == "CONST NilE CONST EventType"
  "_uexpr_list_append e f"     == "CONST ConcatV CONST EventType e f"
  "_uexpr_list (_uexprs x xs)" == "CONST ConsE (CONST EventType) x (_uexpr_list xs)"
  "_uexpr_list x" == "CONST ConsE (CONST EventType) x (CONST NilE CONST EventType)"
