...
definition vfun1 :: "('a::vbasic \<Rightarrow> 'b::vbasic) \<Rightarrow> ('a set) \<Rightarrow> cmlv" where
...
definition vfun2 :: 
  "('a::vbasic \<Rightarrow> 'b::vbasic \<Rightarrow> 'c::vbasic) \<Rightarrow>
   'a set \<Rightarrow> 'b set \<Rightarrow> cmlv" where
...
fun InjVB :: "'a::vbasic option \<Rightarrow> cmlv" where
"InjVB None = BotD VTYPE('a)" |
"InjVB (Some x) = BasicD (Inject x)"

definition ProjVB :: "cmlv \<Rightarrow> 'a::vbasic option" where
