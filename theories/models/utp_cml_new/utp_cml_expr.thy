...
overloading
  InjU_cml  == "InjU  :: 'a::cmlv option \<Rightarrow> cmlm uval" 
  ProjU_cml == "ProjU :: cmlm uval \<Rightarrow> 'a::cmlv option"
  TypeU_cml == "TypeU :: 'a::cmlv option itself \<Rightarrow> cmlm utype"
begin

  lift_definition InjU_cml :: "'a::cmlv option \<Rightarrow> cmlm uval" is "MkCmlv \<circ> InjCML"
    by (simp add:VALUE_cmlm_def)
    
  lift_definition ProjU_cml :: "cmlm uval \<Rightarrow> 'a::cmlv option" is "ProjCML \<circ> DestCmlv" .
  
  lift_definition TypeU_cml :: "'a::cmlv option itself \<Rightarrow> cmlm utype" is "\<lambda> x. MkCmlt(VTYPE('a))"
    by (simp add:UTYPE_cmlm_def)
...
"MkVarD n t \<equiv> MkPlainP n False TYPE('a option) TYPE(cmlm)"
...
definition Op1D :: "('a::cmlv \<rightharpoonup> 'b::cmlv) \<Rightarrow> 'a cmle \<Rightarrow> 'b cmle" where
...
definition Op2D :: "('a::cmlv * 'b::cmlv \<rightharpoonup> 'c::cmlv) 
...
definition Op3D :: "('a::cmlv * 'b::cmlv * 'c::cmlv \<rightharpoonup> 'd::cmlv) 
...
abbreviation TokenD :: "'a::cmlv cmle \<Rightarrow> token cmle" where
"TokenD v \<equiv> Op1D' (Abs_token \<circ> Inject) v"

definition ListD :: "'a::cmlv cmle list \<Rightarrow> 'a list cmle" where
"ListD xs = MkPExpr (\<lambda> b. mapM (\<lambda> v. \<lbrakk>v\<rbrakk>\<^sub>* b) xs)"

definition SetD :: "'a::cmlv cmle bset \<Rightarrow> 'a bset cmle" where
...
definition CollectD :: "'a::cmlv cmle \<Rightarrow> bool cmle \<Rightarrow> 'a set" where
...
definition IfThenElseD :: "bool cmle \<Rightarrow> 'a::cmlv cmle \<Rightarrow> 'a cmle \<Rightarrow> 'a cmle" where
...
syntax
  ...
  "_vexpr_lit"      :: "'a::cmlv \<Rightarrow> n_pexpr" ("(1^_^)")
  "_vexpr_litd"     :: "'a::cmlv \<Rightarrow> n_pexpr" ("(1<<_>>)")
