...
(Modified by Simon Foster to remove the order instances)
*)
...
lift_definition cempty :: "'a cset" is "{}" parametric empty_transfer by simp
lift_definition csubset_eq :: "'a cset \<Rightarrow> 'a cset \<Rightarrow> bool"
  is subset_eq parametric subset_transfer .
lift_definition csubset :: "'a cset \<Rightarrow> 'a cset \<Rightarrow> bool"
  is subset .
lift_definition cUn :: "'a cset \<Rightarrow> 'a cset \<Rightarrow> 'a cset"
is union parametric union_transfer by simp
lift_definition cInt :: "'a cset \<Rightarrow> 'a cset \<Rightarrow> 'a cset"
is inter parametric inter_transfer by simp
lift_definition cDiff :: "'a cset \<Rightarrow> 'a cset \<Rightarrow> 'a cset"
