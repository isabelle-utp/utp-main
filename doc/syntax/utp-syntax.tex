...
\begin{tabular}{|c|c|c|c|} \hline
  ...
  \begin{tabular}{c}                                                                 
    construct substitution with \\[-5pt]
    variable $x_i$ being mapped  \\[-5pt]
    to expresssion $v_i$
  \end{tabular}
                                & \verb|[x1 \mapsto v1,...] \sub s| \\
  $P \llbracket v/x \rrbracket$ & $P[v/x]$                     & apply singleton substitution              & \texttt{P[|v/x|]} \\
  \hline
\end{tabular}  
\end{center}
