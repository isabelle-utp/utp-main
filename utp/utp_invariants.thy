...
lemma ISH_idem: "ISH(\<psi>)(ISH(\<psi>)(D)) = ISH(\<psi>)(D)"
  by (simp add: ISH_design usubst design_def, pred_tac)
...
lemma ISH_of_design: 
  ...
  by (simp add: ISH_design design_def usubst, pred_tac)
...
lemma OSH_as_OIH:
  ...
  by (simp add: OSH_def OIH_def, pred_tac)
...
lemma SIH_of_design:
  ...
  by (simp add: SIH_def OSH_of_design ISH_of_design unrest, pred_tac)
