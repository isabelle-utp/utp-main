...
(* HERE: none of the below currently have static methods or fields; these should be
...
where
  ...
  (''I'', Object,
  [],
  [(''mult'',NonStatic,[Integer,Integer],Integer,[''i'',''j''],
...
where
  "classL ==
  (''L'', Object,
  [(''F'',NonStatic,Integer), (''N'',NonStatic,Class ''L'')],
  [(''app'',NonStatic,[Class ''L''],Void,[''l''],
...
where
  "classA ==
  (''A'', Object,
  [(''int'',NonStatic,Integer),
   (''test'',NonStatic,Class ''A'') ],
  [(''isNull'',NonStatic,[],Boolean,[], mb_isNull),
   (''add'',NonStatic,[Integer],Integer,[''i''], mb_add),
   (''mult'',NonStatic,[Integer,Integer],Integer,[''i'',''j''], mb_mult) ])"
